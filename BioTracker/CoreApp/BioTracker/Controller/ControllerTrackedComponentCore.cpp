...
void ControllerTrackedComponentCore::addModel(IModel* model)
{
	...
	QObject::connect(dynamic_cast<CoreParameterView*>(m_parameterView), &CoreParameterView::emitColorChangeBorderSelected, dynamic_cast<TrackedComponentView*>(m_View), &TrackedComponentView::receiveColorChangeBorderSelected, Qt::DirectConnection);
	...
	QObject::connect(dynamic_cast<CoreParameterView*>(m_parameterView), &CoreParameterView::emitColorChangeBrushSelected, dynamic_cast<TrackedComponentView*>(m_View), &TrackedComponentView::receiveColorChangeBrushSelected, Qt::DirectConnection);
