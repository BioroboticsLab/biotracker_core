...
public:
	Tracer(QVariant type, int frame, float orientation, QPointF pos,
		float w, float h, QPen pen, QBrush brush, QAbstractGraphicsShapeItem* parent);
	~Tracer();
signals:
...
protected:
	...
	float _orientation;   /**< orientation of tracer --> of corresponding entity */
