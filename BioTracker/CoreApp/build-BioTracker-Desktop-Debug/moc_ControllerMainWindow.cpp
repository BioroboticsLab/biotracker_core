...
#include "../BioTracker/Controller/ControllerMainWindow.h"
...
const QMetaObject ControllerMainWindow::staticMetaObject = {
    { &IController::staticMetaObject, qt_meta_stringdata_ControllerMainWindow.data,
      qt_meta_data_ControllerMainWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ControllerMainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ControllerMainWindow.stringdata0))
        return static_cast<void*>(const_cast< ControllerMainWindow*>(this));
