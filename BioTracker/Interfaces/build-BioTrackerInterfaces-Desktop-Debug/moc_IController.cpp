...
#include "../BioTrackerInterfaces/Interfaces/IController/IController.h"
...
const QMetaObject IController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_IController.data,
      qt_meta_data_IController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *IController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IController.stringdata0))
        return static_cast<void*>(const_cast< IController*>(this));
