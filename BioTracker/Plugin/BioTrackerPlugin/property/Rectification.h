...
public:
	...
	{
		static Rectification _instance; // Guaranteed to be destroyed.
...
public:
	...
	void initRecitification(double areaHeight_cm, double areaWidth_cm, std::vector<cv::Point> areaCoordinates);
