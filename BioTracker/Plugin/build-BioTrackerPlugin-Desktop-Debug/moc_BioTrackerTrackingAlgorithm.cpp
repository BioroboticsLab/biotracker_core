...
#include "../BioTrackerPlugin/Model/BioTrackerTrackingAlgorithm.h"
...
static const uint qt_meta_data_BioTrackerTrackingAlgorithm[] = {
 ...
 // slots: parameters
    QMetaType::Void, 0x80000000 | 3, QMetaType::UInt,    4,    7,
...
void BioTrackerTrackingAlgorithm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->doTracking((*reinterpret_cast< std::shared_ptr<cv::Mat>(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
        default: ;
        }
...
const QMetaObject BioTrackerTrackingAlgorithm::staticMetaObject = {
    { &IModelTrackingAlgorithm::staticMetaObject, qt_meta_stringdata_BioTrackerTrackingAlgorithm.data,
...
void *BioTrackerTrackingAlgorithm::qt_metacast(const char *_clname)
{
    ...
    return IModelTrackingAlgorithm::qt_metacast(_clname);
}

int BioTrackerTrackingAlgorithm::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = IModelTrackingAlgorithm::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
