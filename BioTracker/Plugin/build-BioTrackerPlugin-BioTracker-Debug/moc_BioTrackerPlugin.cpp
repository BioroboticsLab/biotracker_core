...
QT_MOC_LITERAL(1, 17, 10), // "emitCvMatA"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 24), // "std::shared_ptr<cv::Mat>"
QT_MOC_LITERAL(4, 54, 3), // "mat"
QT_MOC_LITERAL(5, 58, 4), // "name"
QT_MOC_LITERAL(6, 63, 13) // "receiveCvMatA"

    },
    "BioTrackerPlugin\0emitCvMatA\0\0"
...
void BioTrackerPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BioTrackerPlugin::emitCvMatA)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject BioTrackerPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BioTrackerPlugin.data,
...
void *BioTrackerPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IBioTrackerTrackingInterface"))
        return static_cast< IBioTrackerTrackingInterface*>(const_cast< BioTrackerPlugin*>(this));
    if (!strcmp(_clname, "de.fu-berlin.mi.biorobotics.BioTrackerTrackingInterface"))
        return static_cast< IBioTrackerTrackingInterface*>(const_cast< BioTrackerPlugin*>(this));
...
// SIGNAL 0
void BioTrackerPlugin::emitCvMatA(std::shared_ptr<cv::Mat> _t1, QString _t2)
{
