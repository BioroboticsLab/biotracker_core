...
public:
    explicit CoreParameterView(QWidget*     parent     = 0,
...
private slots:
    ...
    */
    ...
    void on_comboBoxTracingTimeDegradation_currentIndexChanged(
        const QString& text);
...
private:
    ...
    bool m_viewSwitch; /**< switch to enable/disable visualization options tab
                        */
    SwitchButton*
            _expertSwitch; /**< switch to expand visualization options tab  */
    bool    _trialActive  = false; /**< currently trial active?  */
    bool    _trialStarted = false; /**< was trial started?  */
    QString _currentFile =
        "No Media"; /**< show media name in experiment tab  */
