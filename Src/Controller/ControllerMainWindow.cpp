...
ControllerMainWindow::ControllerMainWindow(QObject*              parent,
...
void ControllerMainWindow::loadVideo(
...
void ControllerMainWindow::connectControllerToController()
{
    ...
    QObject::connect(this,
                     &ControllerMainWindow::emitUndoCommand,
                     ctrcmd,
                     &ControllerCommands::receiveUndo,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitRedoCommand,
                     ctrcmd,
                     &ControllerCommands::receiveRedo,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitOnLoadMedia,
                     ctrcmd,
    ...
    QObject::connect(this,
                     ...
                     ctrcmd,
                     &ControllerCommands::receiveShowActionList,
                     Qt::DirectConnection);

    // connect to ControllerGraphicScene
    IController* ictrgrv = m_BioTrackerContext->requestController(
        ENUMS::CONTROLLERTYPE::GRAPHICSVIEW);
    ControllerGraphicScene* ctrgrv = static_cast<ControllerGraphicScene*>(
        ictrgrv);
    GraphicsView* grv = static_cast<GraphicsView*>(ctrgrv->getView());

    QObject::connect(grv,
                     &GraphicsView::emitCursorPosition,
                     this,
                     &ControllerMainWindow::receiveCursorPosition,
                     Qt::QueuedConnection);

    // connect to ControllerTrackedComponentCore
    IController* ictrtrcc = m_BioTrackerContext->requestController(
        ENUMS::CONTROLLERTYPE::TRACKEDCOMPONENTCORE);
    ControllerTrackedComponentCore* ctrtrcc =
        static_cast<ControllerTrackedComponentCore*>(ictrtrcc);

    QObject::connect(this,
                     &ControllerMainWindow::emitAddTrack,
                     ctrtrcc,
                     &ControllerTrackedComponentCore::emitAddTrack,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitDeleteSelectedTracks,
                     ctrtrcc,
                     &ControllerTrackedComponentCore::emitDeleteSelectedTracks,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitSelectAll,
                     ctrtrcc,
                     &ControllerTrackedComponentCore::emitSelectAll,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitSwapIds,
                     ctrtrcc,
                     &ControllerTrackedComponentCore::emitSwapIdsToView,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitChangeColorBorder,
                     ctrtrcc,
                     &ControllerTrackedComponentCore::emitChangeColorBorder,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitChangeColorFill,
                     ctrtrcc,
                     &ControllerTrackedComponentCore::emitChangeColorFill,
                     Qt::DirectConnection);

    // connect to ControllerAnnotations
    IController* ictrann = m_BioTrackerContext->requestController(
        ENUMS::CONTROLLERTYPE::ANNOTATIONS);
    ControllerAnnotations* ctrann = static_cast<ControllerAnnotations*>(
        ictrann);

    QObject::connect(this,
                     &ControllerMainWindow::emitAddLabelAnno,
                     ctrann,
                     &ControllerAnnotations::receiveAddLabelAnnotation,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitAddRectAnno,
                     ctrann,
                     &ControllerAnnotations::receiveAddRectAnnotation,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitAddArrAnno,
                     ctrann,
                     &ControllerAnnotations::receiveAddArrowAnnotation,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitAddEllAnno,
                     ctrann,
                     &ControllerAnnotations::receiveAddEllipseAnnotation,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitDelSelAnno,
                     ctrann,
                     &ControllerAnnotations::receiveDeleteSelectedAnnotation,
                     Qt::DirectConnection);

    // connect to ControllerDataExporter
    IController* ictrde = m_BioTrackerContext->requestController(
        ENUMS::CONTROLLERTYPE::DATAEXPORT);
    ControllerDataExporter* deController =
        static_cast<ControllerDataExporter*>(ictrde);
    QObject::connect(this,
                     &ControllerMainWindow::emitFinalizeExperiment,
                     deController,
                     &ControllerDataExporter::receiveFinalizeExperiment,
                     Qt::DirectConnection);

    // reset trials
    IController* ictrcpv = m_BioTrackerContext->requestController(
        ENUMS::CONTROLLERTYPE::COREPARAMETER);
    ControllerCoreParameter* ctrcpv = static_cast<ControllerCoreParameter*>(
        ictrcpv);
    QObject::connect(this,
                     &ControllerMainWindow::emitOnLoadMedia,
                     ctrcpv,
                     &ControllerCoreParameter::receiveResetTrial,
                     Qt::DirectConnection);
    QObject::connect(this,
                     &ControllerMainWindow::emitOnLoadPlugin,
                     ctrcpv,
    ...
    // batch media signals
    IController* ctr3 = m_BioTrackerContext->requestController(
        ENUMS::CONTROLLERTYPE::PLAYER);
    ControllerPlayer* cont3 = static_cast<ControllerPlayer*>(ctr3);
    QObject::connect(cont3,
                     &ControllerPlayer::emitNextMediaInBatch,
                     this,
                     &ControllerMainWindow::emitOnLoadMedia,
                     Qt::DirectConnection);
    QObject::connect(cont3,
                     &ControllerPlayer::emitNextMediaInBatchLoaded,
                     this,
                     &ControllerMainWindow::emitMediaLoaded,
                     Qt::DirectConnection);
...
void ControllerMainWindow::setCorePermission(
