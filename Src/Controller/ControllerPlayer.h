...
/**
 * The ControllerPlayer class it the controller of the MediaPlayer-Component.
 * This controller creates and controlls the IModel class MediaPlayer and the
 * IView class VideoControllWidget.
 */
...
public:
    ...
    /**
     * Tells the MediaPlayer-Component to hand over the current cv::Mat and the
     * current frame number to the BioTracker Plugin.
     */
    void setTrackingActivated();
    /**
     * Tells the MediaPlayer-Component not to hand over the current cv::Mat and
     * the current frame number to the BioTracker Plugin.
     */
    void setTrackingDeactivated();

    /**
     * Tells the IModel class MediaPlayer to display the next image frame of
     * the ImageStream.
     */
    void nextFrame();
    /**
     * Tells the IModel class MediaPlayer to display the previous image frame
     * of the ImageStream.
     */
    void prevFrame();
    /**
    ...
    void pause();
    /**
     * If the user changes the ImageView in the comboBox represented in the
     * VideoControllWidget it passes the selected ImageView name to the
     * ControllerTextureObject class of the TextureObject-Component.
     */
...
public Q_SLOTS:
    /**
     * This SLOT receives a cv::Mat and a name for the cv::Mat from the
    ...
    /**
     * Tells the IModel class MediaPlayer to jump directly to the specified
     * image frame by the parameter frame.
     */
