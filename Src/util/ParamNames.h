...
namespace ConfigParam
{
    static const boost::filesystem::path CONFIG_PATH = boost::filesystem::path(
        QDir::toNativeSeparators(
            ...
            .toStdString());
    static const boost::filesystem::path BASE_PATH = CONFIG_PATH /
                                                     "BioTracker";
    static const boost::filesystem::path CONFIGURATION_FILE = BASE_PATH /
                                                              "config.json";
    static const boost::filesystem::path GEOMETRY_FILE = BASE_PATH /
                                                         "geometry.cfg";
...
{
    static const std::string TRACKING_ENABLED =
        "TRACKERPARAM.TRACKING_ENABLED";

    static const std::string SELECTED_TRACKER =
        "TRACKERPARAM.SELECTED_TRACKER";
}
