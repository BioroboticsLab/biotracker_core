...
public:
    ...
    {
        // Taken from
        // http://www.boost.org/doc/libs/1_64_0/libs/program_options/example/option_groups.cpp
        using namespace boost;
        using namespace boost::program_options;
        try {
            // Declare three groups of options.
            options_description general("General options");
            general.add_options()("help", "Produce this help message")(
                "usePlugin",
                value<std::string>(),
                "Uses plugin from given filepath")(
                "video",
                value<std::string>(),
                "Loads a video from given filepath")(
                "cfg",
                value<std::string>(),
                "Provide custom path to a config file");
