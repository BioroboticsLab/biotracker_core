...
SpinBoxWithSlider::SpinBoxWithSlider(QWidget *parent, const QString &name,
                                     int min, int max, int start_value, int step_size)
    : QWidget(parent)
...
SpinBoxWithSlider::SpinBoxWithSlider(QWidget *parent, QFormLayout *layout,
                                     const QString &name, int min, int max, int start_value, int step_size)
...
DoubleSpinBoxWithSlider::DoubleSpinBoxWithSlider(QWidget *parent,
        const QString &name, double min, double max, double start_value, int precision)
    : QWidget(parent)
    ...
    m_slider.setOrientation(Qt::Horizontal);
    m_slider.setRange(static_cast<int>(m_factor * min),
                      static_cast<int>(m_factor * max));
...
DoubleSpinBoxWithSlider::DoubleSpinBoxWithSlider(QWidget *parent,
        QFormLayout *layout, const QString &name, double min, double max,
        double start_value, int precision)
